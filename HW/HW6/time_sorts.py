...
if __name__ == "__main__":
    ...
    print("Size | Built In    |    Gnome    |  BubbleSort  | InsertionSort |  MergeSort  |  QuickSort |  Heap Sort  |")
    for x in range(0, 9):
        rowTemplate = "{:4d} | {:11.5} | {:11.5f} | {:11.5f}  |  {:11.5f}  | {:11.5f} | {:11.5f}| {:11.5f} |"
        ...
        heap = test_a_sort("heapsort", 2 ** x)

        print(rowTemplate.format(2 ** x, built, gnome, bubble, insertion, merge, quick, heap))
